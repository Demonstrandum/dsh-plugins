...
const wae = fixture('web-automation-errors') // deepseek-harness/web-automation-errors, cwd /Users/USER/projects/deepseek-harness
...
const other = { session: { ...wae.session, id: 'session-aaaaaaaa-0000-0000-0000-000000000000', cwd: '/Users/USER/github/tensatory', createdAt: wae.session.createdAt + 1 }, events: wae.events.filter(e => e.type !== 'session/title') }
...
const exec = fakeExec(SELF, '/Users/USER/projects/deepseek-harness')
