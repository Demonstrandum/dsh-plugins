...
```
wrote 1 204 lines, 318 KB (fmt=jsonl) to /Users/USER/github/tensatory/.dsh-transcripts/interval-slider-proto.jsonl
head:
...
2. **Headless end-to-end** without the GUI (no launch token needed), against a copy of the live home so nothing live is touched:
   ...
   - insert:
       - id: tali-session-introspect
         name: '/Users/USER/github/tali-dash-plugins/plugins/session-introspect/index.js'
