...
**Goal (the maintainer, 2026-09-16):** provide a session name at *creation* time by
...
The maintainer: selecting another session made the phantom New Session disappear;
...
was non-empty — a duplicate "New Session" row (the maintainer's screenshot: a dimmed
