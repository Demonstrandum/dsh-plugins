...
# plugins' schema defaults, which equal the maintainer's live settings; override by id
...
# The live set. Deliberately absent: agent-status-indicator (not in the maintainer's
